...
const Header = ({ index, title, description }) => {
  return (
    <div className="flex flex-col gap-4">
      ...
      <p className="text-sm sm:text-base max-auto text-center">{description}</p>
    </div>
  );
};
  ...
  return (
    ...
    >
      ...
      <Header
        ...
        description={"Select the judged for annihilation."}
      />
      <div className="bg-slate-950 border border-solid border-blue-400 rounded-lg">
        <button
          ...
          className="relative p-3 flex items-center justify-center flex flex-col w-full"
        >
